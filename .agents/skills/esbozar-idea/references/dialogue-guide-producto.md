...
1. **Carácter de la idea**: ¿Qué valores distinguen esta idea de alternativas? (no es diseño de solución — es declaración de intenciones: reproducibilidad, seguridad, agnosticismo, etc.).
...
6. **Contexto organizacional**: ¿Qué organización o equipo genera la idea? (puede inferirse del repo o del workspace — confirma brevemente).
