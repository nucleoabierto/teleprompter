...
- **Infiere antes de preguntar**: para features, inferir del repo es la regla y preguntar solo lo que el repo no responde. Confirma brevemente en lugar de interrogar.
